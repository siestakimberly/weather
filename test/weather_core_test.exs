defmodule WeatherCoreTest do
    ...
    describe "api_city_weather_slc/1" do
      test "it returns the max weather temperature for the requested city" do
        use_cassette "weather_core_api_successful_request_3" do
          response = WeatherCore.api_city_weather(0)
    ...
    describe "api_city_weather_la/1" do
      test "it returns the max weather temperature for the requested city" do
        use_cassette "weather_core_api_successful_request_4" do
          response = WeatherCore.api_city_weather(1)
    ...
    describe "api_city_weather_boise/1" do
      test "it returns the max weather temperature for the requested city" do
        use_cassette "weather_core_api_successful_request_5" do
